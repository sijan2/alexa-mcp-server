/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d39be597baff7b37b40c0e64b5eb0633)
// Runtime types generated with workerd@1.20250924.0 2025-03-10 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "HomeIOMCP";
	}
	interface Env {
		API_BASE: string;
		UBID_MAIN: string;
		AT_MAIN: string;
		MCP_OBJECT: DurableObjectNamespace<import("./src/index").HomeIOMCP>;
	}
}
